...
class AircraftTemplateManager(TrackingModel, models.Model):
    ...
    year_manufactured = models.IntegerField(_("Year of manufacture"), blank=True, null=True)
    ...
    source = models.CharField(_("Source of data"), max_length=100, default="DIRECT") # DIRECT, CSV, API
